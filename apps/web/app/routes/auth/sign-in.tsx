  ...
  return (
    <main class="min-h-screen bg-[#10130f] px-5 py-8 text-stone-50">
      ...
      <section class="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <div class="relative overflow-hidden rounded-xl border border-lime-200/10 bg-[radial-gradient(circle_at_20%_10%,rgba(190,242,100,.22),transparent_32%),linear-gradient(135deg,#14180f,#0b0d0a)] p-8 shadow-2xl shadow-black/30">
