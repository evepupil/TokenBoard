...
export function renderUsageCardSvg(input: UsageCardInput) {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="420" height="120" role="img" aria-label="AI token 使用统计">
  ...
  <text x="24" y="68" fill="#a1a1aa" font-family="Arial, sans-serif" font-size="14">今日 tokens</text>
  <text x="148" y="68" fill="#fafafa" font-family="Arial, sans-serif" font-size="16">${input.todayTokens.toLocaleString()}</text>
  <text x="24" y="96" fill="#a1a1aa" font-family="Arial, sans-serif" font-size="14">本月费用</text>
